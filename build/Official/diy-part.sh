...
# 设置自定义信息，包含日期
CUSTOM_INFO="04543473 $(TZ=UTC-8 date "+%Y.%m.%d")"

# 修改 openwrt_release 中的 DISTRIB_DESCRIPTION 字段
sed -i "s/DISTRIB_DESCRIPTION='.*'/DISTRIB_DESCRIPTION='$CUSTOM_INFO'/" package/base-files/files/etc/openwrt_release
